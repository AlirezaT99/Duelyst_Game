...
public class UpdateWholeShop extends ShopCommand {
    ...
    public UpdateWholeShop(HashMap<String, Integer> collectionCardNumbers, long money, HashSet<String> costumeCards, ArrayList<ArrayList<String>> cards, ArrayList<ArrayList<String>> collectionCards, HashMap<String, int[]> movableCardsPowers, HashMap<String, Integer> costs, HashMap<String, Integer> cardsNumbers) {
        super("");
        this.money = money;
        ...
        this.cardCollectionNumbers = gson.toJson(collectionCardNumbers);
    }
    ...
    public HashMap<String, int[]> getPowers() {
        Gson gson = new Gson();
        Type type = new TypeToken<HashMap<String, int[]>>() {
        }.getType();
