...
public class SinglePlayerMenuFX {
    ...
    private VBox customGameSetUp(Scene battleInitScene, Font font, Account account) throws FileNotFoundException {
        ...
        ImageView customGameView = new ImageView(customGameImage);
        customGameView.setFitWidth(battleInitScene.getWidth() / 4);
        customGameView.setFitHeight(battleInitScene.getHeight() * 2 / 3);
        StackPane view = new StackPane(customGameView);
